            ...
            <div class="row">
                <div class="col-md-4 flex">
                    <div class="menu d-flex flex-row bd-highlight mb-3">
                        <div class="p-3 bd-highlight"><a href="/"><font-awesome-icon :icon="['fas', 'home']"  />HOME</a></div>
                        <div class="p-3 bd-highlight"><a href="/product">
                ...
                <div class="col-md-4 d-flex justify-content-end">
                    <div class="menu d-flex flex-row bd-highlight mb-3">
                        <!-- <div class="p-3 search__container">
                            ...
                            <button type="button" class="btn btn-primary"  @click="searchProduct" >Tìm kiếm</button>
                        </div> -->
                        <div class="p-3 bd-highlight">
                            <div v-if="$auth.loggedIn"  >
                                ...
                                <div class="list">
                                    ...
                                    <li>
                                      <a href="/user/order_list">
                                        Đanh sách đơn hàng
                                      </a>
                                    </li>
                                    <li>
                                        <button @click.prevent="logout" type="submit" class="btn btn-primary">Đăng Xuất</button>
                                    </li>
                                    </ul>
                                </div>
                                <div class="dot"></div>
...
.dot {
  background: black;
  clip-path: polygon(51% 46%, 3% 0, 100% 0);
  height: 10px;
  margin-top: 10px;
  margin-left: 2px;
  margin-right: 5px;
